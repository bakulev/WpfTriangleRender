...
namespace InteractiveDataDisplay.WPF
{
    ...
    public abstract class PlotBase : Panel
    {
        ...
        public event EventHandler<PlotCompositionChange> CompositionChange; // = new Subject<PlotCompositionChange>();
        ...
        protected void NotifyCompositionChange()
        {
            ...
            EventHandler<PlotCompositionChange> compositionChange = this.CompositionChange;
            if (compositionChange != null)
            {
                compositionChange(this, new PlotCompositionChange());
            }
        }
